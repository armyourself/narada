...
These tests focus on the interface contract and the IMAP/SMTP
...
def test_message_source_imap():
    assert MessageSource.IMAP.value == "imap"


def test_message_source_nostr():
    assert MessageSource.Nostr.value == "nostr"
