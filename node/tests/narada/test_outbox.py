...
from src.narada.outbox import Outbox, OutboxEntry


def _envelope_dict(message_id: str, recipient: str = "narada1xyz") -> dict:
    return {
        "v": 1,
        "sender_public_id": "narada1sender",
