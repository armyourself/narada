"""Keypair generation and operations for Narada identities.

A Narada keypair bundles:
...
X25519_INFO = b"Narada-x25519-from-ed25519-seed"
SEED_LEN = 32
...
@dataclass
class Keypair:
    """A narada keypair (Ed25519 + X25519)."""
    ...
    def shared_secret_with(self, peer_x25519_public_bytes: bytes) -> bytes:
        ...
        try:
            ...
            # invalid-curve points. Surface as a typed Narada error
...
def generate_keypair() -> Keypair:
    """Generate a fresh, random narada keypair."""
...
def keypair_from_seed(seed: bytes) -> Keypair:
    """Build a Narada keypair from a 32-byte Ed25519 seed.
...
def verify_signature(
    ...
    try:
        ...
        # belt-and-suspenders.
        raise NaradaIdentityError("Invalid Ed25519 public key") from exc
